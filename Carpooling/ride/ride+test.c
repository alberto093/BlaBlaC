...
void test_sort_rides(void) {
    ...
    rating ratings1[total_ratings1] = {rating_excellent, rating_oustanding, rating_oustanding, rating_excellent};
    rating ratings2[total_ratings2] = {rating_poor, rating_oustanding, rating_good};
    rating ratings3[total_ratings3] = {rating_good, rating_very_poor};
    ...
    driver driver3 = create_driver_with(code2, ratings2, total_ratings2);
